...
int main() {
	...
	while (true) {
		...
		float camera_x = (matrix[0][0] * enemy_x + matrix[1][0] * enemy_y + matrix[2][0] * enemy_z + matrix[3][0]) * ratio* (float)view_port_width;
		float camera_y = (matrix[0][1] * enemy_x + matrix[1][1] * enemy_y + matrix[2][1] * enemy_z + matrix[3][1]) * ratio * (float)view_port_height;
